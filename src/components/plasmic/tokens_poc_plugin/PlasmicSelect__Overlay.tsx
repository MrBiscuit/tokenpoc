...
import sty from './PlasmicSelect__Overlay.module.css'; // plasmic-import: YdYhrXoxJA1/css
...
export const PlasmicSelect__Overlay__VariantProps = new Array<VariantPropType>('relativePlacement');
...
export const PlasmicSelect__Overlay__ArgProps = new Array<ArgPropType>('children');
...
export interface DefaultSelect__OverlayProps extends pp.BaseTriggeredOverlayProps {
  children?: React.ReactNode;
}
...
function PlasmicSelect__Overlay__RenderFunc(props: {
  ...
  return (
    ...
    >
      {(hasVariant($state, 'relativePlacement', 'bottom') ? true : true) ? (
        <div
          data-plasmic-name={'top'}
          data-plasmic-override={overrides.top}
          className={classNames(projectcss.all, sty.top, {
            [sty.toprelativePlacement_bottom]: hasVariant($state, 'relativePlacement', 'bottom'),
          })}
        />
      ) : null}
        ...
        {(hasVariant($state, 'relativePlacement', 'right') ? true : false) ? (
          <div
            ...
            className={classNames(projectcss.all, sty.left, {
              [sty.leftrelativePlacement_right]: hasVariant($state, 'relativePlacement', 'right'),
            })}
          />
        ) : null}
        ...
        {(hasVariant($state, 'relativePlacement', 'left') ? true : false) ? (
          <div
            ...
            className={classNames(projectcss.all, sty.right, {
              [sty.rightrelativePlacement_left]: hasVariant($state, 'relativePlacement', 'left'),
            })}
          />
        ) : null}
      </div>

      {(hasVariant($state, 'relativePlacement', 'top') ? true : true) ? (
        <div
          data-plasmic-name={'bottom'}
          data-plasmic-override={overrides.bottom}
          className={classNames(projectcss.all, sty.bottom, {
            [sty.bottomrelativePlacement_top]: hasVariant($state, 'relativePlacement', 'top'),
          })}
        />
      ) : null}
    </div>
...
type NodeOverridesType<T extends NodeNameType> = Pick<PlasmicSelect__Overlay__OverridesType, DescendantsType<T>>;
