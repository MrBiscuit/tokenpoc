...
import projectcss from "./plasmic_blank_project.module.css"; // plasmic-import: 2z5rPdFHZr7bZiak9bFJHw/projectcss
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: -Ka_gvZbo3br/css

import ChecksvgIcon from "../tokens_poc_plugin/icons/PlasmicIcon__Checksvg"; // plasmic-import: _flsZuGE13Q/icon
import Icon3Icon from "../tokens_poc_plugin/icons/PlasmicIcon__Icon3"; // plasmic-import: 5ZgdjROksJ0/icon
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__dxj39)}>
              ...
              >
                <Select__Option
                  className={classNames("__wab_instance", sty.option__ujBy0)}
                  value={"1" as const}
                >
                  {"Option 1"}
                </Select__Option>
                ...
                <Select__Option
                  className={classNames("__wab_instance", sty.option__hCyd)}
                  value={"2" as const}
                >
                  {"Option 2"}
                </Select__Option>
                ...
                <Select__Option
                  className={classNames("__wab_instance", sty.option__aRsK8)}
                  value={"3" as const}
                >
                  {"Option 3"}
                </Select__Option>
                ...
                <Select__Option
                  className={classNames("__wab_instance", sty.option___1OAXc)}
                  value={"4" as const}
                >
                  {"Option 4"}
                </Select__Option>
              ...
              >
                <Select__Option
                  className={classNames("__wab_instance", sty.option__gUt1X)}
                  value={"1" as const}
                >
                  {"Option 1"}
                </Select__Option>
                ...
                <Select__Option
                  className={classNames("__wab_instance", sty.option___5Jtbh)}
                  value={"2" as const}
                >
                  {"Option 2"}
                </Select__Option>
                ...
                <Select__Option
                  className={classNames("__wab_instance", sty.option___8G3F)}
                  value={"3" as const}
                >
                  {"Option 3"}
                </Select__Option>
                ...
                <Select__Option
                  className={classNames("__wab_instance", sty.option__n7AvP)}
                  value={"4" as const}
                >
                  {"Option 4"}
                </Select__Option>
              ...
              >
                <Select__Option
                  className={classNames("__wab_instance", sty.option__oQwH)}
                  value={"1" as const}
                >
                  {"Option 1"}
                </Select__Option>
                ...
                <Select__Option
                  className={classNames("__wab_instance", sty.option__rztMh)}
                  value={"2" as const}
                >
                  {"Option 2"}
                </Select__Option>
                ...
                <Select__Option
                  className={classNames("__wab_instance", sty.option__y712P)}
                  value={"3" as const}
                >
                  {"Option 3"}
                </Select__Option>
                ...
                <Select__Option
                  className={classNames("__wab_instance", sty.option__iq3Xz)}
                  value={"4" as const}
                >
                  {"Option 4"}
                </Select__Option>
